...
public class APIWorkflowStep {
    ...
    public void the_status_code_for_this_request_is(Integer statusCode) {
        ...
        //response.then().assertThat().
                //body("Employee.emp_firstname",equalTo("nike"));
        response.then().assertThat().
...
//------------------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------------------
    @Given("a request is prepared to get the all created employees")
    public void a_request_is_prepared_to_get_the_all_created_employees() {
        request = given().
                header(APIConstants.HEADER_CONTENT_TYPE_KEY,APIConstants.CONTENT_TYPE_VALUE).
                header(APIConstants.HEADER_AUTHORIZATION_KEY, token);

    }
    @When("a GET call is made to get the all employees")
    public void a_get_call_is_made_to_get_the_all_employees() {
        response = request.when().get(APIConstants.GET_ALL_EMPLOYEE_URI);
        response.prettyPrint();
    }

    @Given("a request is prepared to get the all job titles")
    public void a_request_is_prepared_to_get_the_all_job_titles() {
        request = given().
                header(APIConstants.HEADER_CONTENT_TYPE_KEY,APIConstants.CONTENT_TYPE_VALUE).
                header(APIConstants.HEADER_AUTHORIZATION_KEY, token);
    }
    @When("a GET call is made to get the all job titles")
    public void a_get_call_is_made_to_get_the_all_job_titles() {
